...
const redirectUriClient = `http://transtalk.shop/oauth/callback/kakao/client`
const redirectUriTranslator = `http://transtalk.shop/oauth/callback/kakao/translator`
